...
# 📖 [WriteWave Blog App] <a name="about-project"></a>

WriteWave is your creative sanctuary for writing, sharing, and discovering captivating stories. With a user-friendly interface, intuitive tools, and a vibrant community, BlogBreeze empowers bloggers of all levels to express their thoughts, connect with like-minded individuals, and explore a world of captivating narratives. Whether you're a seasoned writer or just starting your blogging journey, BlogBreeze is the wind beneath your wings, helping you craft, publish, and inspire in a breeze.
**[WriteWave]** is a Ruby on Rails project.
...
```sh
  git clone https://github.com/kanyorok/WriteWave-Blog.git
  cd WriteWave-Blog
```
### Install
